...
-- Started on 2025-04-10 14:22:13
...
--
-- TOC entry 226 (class 1259 OID 534311)
-- Name: attendsevents; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.attendsevents (
    eventid integer NOT NULL,
    userid integer NOT NULL
);


ALTER TABLE public.attendsevents OWNER TO postgres;
...
--
-- TOC entry 4725 (class 2606 OID 534125)
...
--
-- TOC entry 4723 (class 2606 OID 534118)
...
--
-- TOC entry 4731 (class 2606 OID 534148)
...
--
-- TOC entry 4729 (class 2606 OID 534135)
...
--
-- TOC entry 4726 (class 1259 OID 534154)
...
--
-- TOC entry 4727 (class 1259 OID 534141)
...
--
-- TOC entry 4732 (class 1259 OID 534319)
-- Name: fki_eventid; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX fki_eventid ON public.attendsevents USING btree (eventid);


--
-- TOC entry 4733 (class 1259 OID 534325)
-- Name: fki_userid; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX fki_userid ON public.attendsevents USING btree (userid);


--
-- TOC entry 4735 (class 2606 OID 534160)
...
--
-- TOC entry 4734 (class 2606 OID 534165)
...
--
-- TOC entry 4737 (class 2606 OID 534297)
...
--
-- TOC entry 4736 (class 2606 OID 534155)
...
--
-- TOC entry 4738 (class 2606 OID 534173)
...
--
-- TOC entry 4739 (class 2606 OID 534314)
-- Name: attendsevents eventid; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendsevents
    ADD CONSTRAINT eventid FOREIGN KEY (eventid) REFERENCES public.event(eventid) ON UPDATE SET DEFAULT ON DELETE CASCADE NOT VALID;


--
-- TOC entry 4740 (class 2606 OID 534320)
-- Name: attendsevents userid; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Completed on 2025-04-10 14:22:13
