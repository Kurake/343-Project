        ...
        <div className="chat_app" onClick={(e) => handleAppClick(e)}>
            ...
            <div className="chat_area">
                ...
                <div className="chat_bg">
                                        ...
                                        <div className={msg.userId === user.userId ? "message_holder me" : "message_holder"} key={idx}>
                                            ...
                                            <div className="message_box">
                                                <div className="message">
                                                    <span className="message_name">{msg.screenname}</span>
                    ...
                    <div style={{ marginLeft: 15, color: "#f48235" }}><i>{(userTyping && userTyping !== user.screenname) && `Typing ${userTyping}`}</i></div>
                            ...
                            <div 
                                ...
                                <div className="room_item_content">
                                    ...
                                    <div className="roomInfo">
                                        <span>{room.name}</span>
                                        <span className="room_author">{room.screenname}</span>
                                    </div>
                                </div>
